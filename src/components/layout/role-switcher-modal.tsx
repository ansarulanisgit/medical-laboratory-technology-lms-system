  ...
  return (
    <>
      ...
      <button
        ...
        className="h-9 px-2.5 rounded-xl border border-border/80 bg-card text-foreground hover:bg-muted/60 transition-all flex items-center gap-1.5 shadow-2xs group cursor-pointer shrink-0 select-none"
      >
